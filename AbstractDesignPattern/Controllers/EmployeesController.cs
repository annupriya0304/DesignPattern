...
using AbstractDesignPattern.Manger;
...
namespace AbstractDesignPattern.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewBag.Id = new SelectList(db.Employee_Type, "Id", "Type");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Salary,Bonus,Type,Designation")] Employee employee)
        {
            if (ModelState.IsValid)
            {
